(function () {
    ...
    app.controller('AppController', ['$http', function ($http) {
        ...
        $scope.addStudent = function () {
            var req = $http.post("add.jsp", $scope.student);
            req.success(function (res) {
                console.log(res);
        ...
        $scope.editStudent = function () {
            var req = $http.post("edit.jsp", $scope.student);
            req.success(function (res) {
                console.log(res);
                if (!res.result) {
                    $scope.error = res.error ? res.error : res;
        ...
        $scope.deleteStudent = function () {
            var req = $http.post("delete.jsp", $scope.student);
            req.success(function (res) {
                if (!res.result) {
                    $scope.error = res.error ? res.error : res;
                }
        ...
        $scope.queryDatabase = function () {
            var req = $http.post("query.jsp", {query: $scope.queryData});
            req.success(function (res) {
                if (!res.result) {
                    $scope.error = res.error ? res.error : res;
                }
